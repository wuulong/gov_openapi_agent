...
# 根據當前時間生成唯一的日誌檔案名
log_filename = datetime.now().strftime("gov_openapi_agent_events_%Y%m%d_%H%M%S.log") # Changed log filename
...
# --- Constants ---
APP_NAME = "gov_openapi_app" # Changed APP_NAME
USER_ID = "test_user_123"
SESSION_ID = "gov_openapi_session_456" # Changed SESSION_ID
...
async def main():
    ...
    if ENABLE_TELEMETRY_LOGGING:
        ...
        print(f"您可以使用 'tail -f {log_filepath}' 來即時監控日誌。 সন")
    else:
        print("遙測日誌已關閉。")
